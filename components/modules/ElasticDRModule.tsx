            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    >
                        ...
                        >
                            <option value={InstanceType.T3_MICRO}>t3.micro</option>
                            <option value={InstanceType.T3_MEDIUM}>t3.medium (Recommended)</option>
                            <option value={InstanceType.M5_LARGE}>m5.large</option>
                        </AWSSelect>
                    </FormSection>
                </div>
            </div>
